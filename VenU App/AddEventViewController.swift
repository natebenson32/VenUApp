    ...
    override func viewDidLoad() {        
        ...
        form +++ Section("")
            ...
            <<< ActionSheetRow<String>() { row in
                ...
                row.options = ["None","Food","Outoors","Late Night","Sport"]
...
//            
//            self.delegate?.set(inputData: EventObject(eventName: name, eventDate: date, eventTime: time, eventType: type, eventLoc: loc, eventDesc: desc, eventLat: lat, eventLon: lon, eventPub: pub, placeId: id))
...
extension AddEventViewController: GMSAutocompleteViewControllerDelegate {
                        ...
                        didAutocompleteWith place: GMSPlace)
    {
        ...
        self.entry?.placeId = place.placeID
        self.entry?.eventLat = place.coordinate.latitude
        self.entry?.eventLon = place.coordinate.longitude
